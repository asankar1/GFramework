...
INCLUDEPATH += $$GFRAMEWORK_SOURCE_PATH/third_party/boost
INCLUDEPATH += $$GFRAMEWORK_SOURCE_PATH/third_party/glm
INCLUDEPATH += $$GFRAMEWORK_SOURCE_PATH/third_party/lua
